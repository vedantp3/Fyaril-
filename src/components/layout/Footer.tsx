      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 border-t border-white/20 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex gap-4 mt-4 md:mt-0">
            <a href="https://www.facebook.com/Fyaril/" className="hover:text-fyaril-lightblue transition-colors">
            ...
            <a href="https://www.instagram.com/fyaril_ab/" className="hover:text-fyaril-lightblue transition-colors">
